...
function displayCardsDynamically(collection) {
    ...
    db.collection(collection).get().then(allHikes => {
        allHikes.forEach(doc => {
            ...
            // Update title, length, details, and image
            ...
            // Set bookmark icon ID
            newcard.querySelector('i').id = 'save-' + docID;
            
            // Set the onclick function to save bookmark
            newcard.querySelector('i').onclick = () => saveBookmark(docID);
            
            // Ensure that the bookmark displays correctly if it is already in the user's favorites
            currentUser.get().then(userDoc => {
